defmodule MetalGrimoireWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MetalGrimoireWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MetalGrimoireWeb.Gettext, "errors", msg, opts)
    end
  end
